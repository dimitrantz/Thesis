...
class SpeedDiagram extends Component {
  constructor(props){
    super(props)
    this.state = {
        measurements: [],
      ...
      return (
        ...
        <div className="diagram">
            ...
            <div className="diagram-title">
                    <div className="subtitle">Speed Data Measured</div>
                ...
                <div className="diagram-measurements">
                  ...
                  {this.state.measurements.map(c => 
                        <div className="data_measure">
                            <p className="colA">
                                Linear Velocity: {Math.sqrt(Math.pow(c.twist.ang_x,2) + Math.pow(c.twist.ang_y,2) + Math.pow(c.twist.ang_z,2) ) } | Angular Velocity: {Math.sqrt(Math.pow(c.twist.lin_x,2) + Math.pow(c.twist.lin_y,2) + Math.pow(c.twist.lin_z,2) ) }
                            </p>
