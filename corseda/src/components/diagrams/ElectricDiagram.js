...
class ElectricDiagram extends Component {
  constructor(props){
    super(props)
    this.state = {
        measurements: [],
          ...
          return (
              <div className="diagram">
                  <div className="diagram-title-before">
                    <p>Category: {this.state.category} | Sensor: {this.state.sensor} | TYPE: {this.state.index} <br/> Refresh Rate: {this.state.frequency}sec | AlarmValue(%): {this.state.alarmValue}</p>
                    <button onClick={this.handleClick}>
                      {this.state.isVisible ? 'HIDE' : 'SHOW'}
                    </button> 
                  </div>    
                  <div className="diagram-title">
                          <div className="subtitle">Electric Data Measured (%)</div>
